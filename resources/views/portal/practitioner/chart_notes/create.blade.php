...
?>
<div id='NewChartNote' class="central fit-content">
    ...
    <div id="ConfirmApptForNote" class='confirmAppt' data-url='/appointment/apptId/edit-chart-note'>
        ...
        <div id="ApptLegend" class='flexbox styled'>
            <div class="appt hasNote">unsigned note</div>
            <div class="appt noNote">no note</div>
        </div>
        <div id="ApptsList" class='flexbox styled'>
            @forelse ($allAppts as $appt)
                <?php $noteIndicator = $appt->chartNote ? 'hasNote' : 'noNote'; ?>
                <div class="appt {{ $noteIndicator }}" data-uid='{{ $appt->id }}'
...
<div id="ChartNote" class='central fit-content'></div>
