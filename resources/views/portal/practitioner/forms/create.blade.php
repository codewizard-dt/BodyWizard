...
<div id='FormBuilder'>
    ...
    <div id="AddItem">
        ...
        <div id='NumberOptions' class='options'>
            <span>Options:</span>
        ...
        <div id='TimeOptions' class='options'>
            <span>Options:</span>
        ...
        <div id='ScaleOptions' class='options'>
            <span>Settings:</span>
        ...
        <div id="FollowUpOptions" class='options'>
            <span>Condition:</span>
        ...
        <div id='SignatureOptions' class='options'>
            <span>Settings:</span>
