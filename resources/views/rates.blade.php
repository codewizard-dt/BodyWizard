...
@section('content')
        <div class='splash' id='shelf_1'>
            <h1 class='p-y-25 shaded30 purple'>Appointments and Rates</h1>
        </div>
        <div class='menuBar website' id='RateMenu' data-populated='no' data-target='window' data-mode='scroll'>
            ...
            <div class='tab' id='meditation'><div class='title'>Guided Meditaiton + Breathing</div></div>
        </div>
        <div class='central large p-y-150' id='Rates'>
            <div class='split40' id ='EvaluationRates'>
                <div class='splash'></div>
                <div class='left paddedSides leftOnly'>
                    <div class="divider yellow"></div>
                    <h4 class='p-y-50'>Evaluation + Diagnosis <span class='little italic'>(not for treatment)</span></h4>
            ...
            <div class='split40' id ='AcuRates'>
                ...
                <div class='left paddedSides leftOnly'>
                    <div class="divider yellow"></div>
                    <h4 class='p-y-50'>Acupuncture Treatment</h4>
                    ...
                    <p><span class='price pink bold'>$115</span><span class='underlined'>Extended Acupuncture (90 minute)</span> - recommended for specific cases of psychosocial conditions that benefit from longer treatment times</p>
                </div>
            </div>
            <div class='split40' id ='BotanicalRates'>
                ...
                <div class='left paddedSides leftOnly'>
                    <div class="divider yellow"></div>
                    <h4 class='p-y-50'>Botanical Medicine</h4>
                    ...
                    <p><span class='price pink bold'>$24</span><span class='underlined'>Patent Medicine (100 capsules)</span> - botanicals encapsulated in pill form, approx. 2 week supply, not customized</p>
                    <p><span class='price pink bold'>varies</span><span class='underlined'>Powdered Medicine (varies)</span> - customized medicinal powder, mix with warm water to take</p>
                    <p><span class='price pink bold'>$25</span><span class='underlined'>Evil Bone Water (3.5 oz)</span> - our favorite topical for muscle and joint pain, including chronic pain and recent injuries</p>
                </div>
            </div>
            <div class='split40' id ='FascialRates'>
                ...
                <div class='left paddedSides leftOnly'>
                    <div class="divider yellow"></div>
                    <h4 class='p-y-50'>Fasical Release</h4>
            ...
            <div class='split40' id ='MeditationRates'>
                ...
                <div class='left paddedSides leftOnly'>
                    <div class="divider yellow"></div>
                    <h4 class='p-y-50'>Guided Meditation + Breathing</h4>
