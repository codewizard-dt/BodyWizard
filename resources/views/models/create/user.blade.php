<?php
// $instance = Auth::user();
$attrs = ['date_of_birth', 'first_name', 'middle_name', 'last_name', 'preferred_name', 'phone', 'email', 'address_mailing', 'address_billing', 'username', 'user_id'];
$initial = collect($attrs)
    ->mapWithKeys(function ($attr) use ($instance) {
        return [$attr => isset($instance) ? $instance->$attr : null];
    })
    ->toArray();

?>
<div id="User" class="central fit-content left">
    <div class="section">
        <h2>Personal Information</h2>
        @include('layouts.forms.display.answer',[
        'type' => 'date',
        'name' => 'date_of_birth',
        'options' => ['preLabel' => 'Date of Birth','preLabelClass'=>'text-xlarge darkgray','yearRange' =>
        'c-110:c+0','date_limit'=>1]
        ])
...
{{-- <div class="hidden" data-original="{{ json_encode($initial) }}"></div> --}}
