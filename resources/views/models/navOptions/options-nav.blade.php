@if (isset($instance))
    ...
    <div class="optionsNavWrapper">
        <h2 class="optionsNavHeader purple p-y-xsmall topOnly">{{ $instance->name }}</h2>
        <div id="Current{{ $model }}" class="optionsNav" data-uid="{{ $uid }}"
            data-model="{{ $model }}" data-options='{{ $attrs }}'>
...
@else
    <div class="optionsNavWrapper empty">
        <h3 class="optionsNavHeader purple p-y-xsmall topOnly"></h3>
