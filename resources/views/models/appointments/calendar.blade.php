...
<div class="calendar">
	...
	<div class="schedule" data-rendering='none' data-modal='ScheduleBlock' data-model='Practitioner' data-uid='{{$practitioner->getKey()}}' data-responses="{{$practitioner->schedule ? json_encode($practitioner->schedule,true) : 'null'}}"></div>
	@endforeach
	<div class="schedule" data-rendering='background' data-modal='ScheduleBlock' data-model='Practice' data-uid='{{$practice->getKey()}}' data-responses="{{$practice->schedule ? json_encode($practice->schedule,true) : 'null'}}"></div>
