...
@section('content')
        ...
        <div class='menuBar website' id='ConditionMenu' data-populated='no' data-target='window' data-mode='scroll'>
            ...
            <div class='tab' id='psychosocial'><div class='title'>Psychosocial Conditions</div></div>
        </div>
        <div id='Conditions' class='central large left listings'>
            ...
            <div id='MuscleJointPainListing'>
                ...
                <h4>A typical treatment plan for muscle and joint pain includes <span class='bold'>acupuncture</span> and <span class='bold'>fascial release</span>, although your treatment plan may be different.</h4>
            ...
            <div id='PsychoSocialListing'>
                ...
                <h4>A typical treatment plan for psychosocial conditions includes <span class='bold'>acupuncture</span> and <span class='bold'>guided meditation + breathing</span>, although your treatment plan may be different.</h4>
        ...
        <div id='ServiceDesc' class='small paddedXBig'>
            <div class='wrapper'>
