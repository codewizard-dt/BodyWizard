...
@section('content')
        <div class='splash btnPopDown top' id='palosanto'>
            <h1 class='purple p-y-25 shaded30'>About Us</h1>
            <div class='button small pink booknow'>book an appointment</div>
        </div>
        
        <div class='central large'>
            <h2 class='yellow p-y-50'>Science, Medicine, Art</h2>
        ...
        <div class='split60 central large p-y-150'>
            <div>
                <div class='splash' id='headshot'></div>
                <div>
                    <h3 class='left p-y-50'>David Taylor, MSOM LAc</h3>
            ...
            <div class='paddedSides leftOnly left'>
                ...
                <h3 class='p-y-50'>Education + Training</h3>
